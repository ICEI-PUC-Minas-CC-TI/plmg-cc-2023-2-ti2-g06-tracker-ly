...
public class Aplicacao {
    ...
    public static void main(String[] args) {
        ...
        // [OK] http://localhost:4567/habitocadastro?id=4&nome=bibshabituada&descr=teste&freq=1&hora=13:00&user_id=7
        post("/habitoscadastro", (request, response) -> HabitoService.cadastro(request, response));

        // [OK] http://localhost:4567/habitoslistar?user_id=7
        get("/habitoslistar", (request, response) -> HabitoService.listar(request, response));

        // [OK] http://localhost:4567/habitosdelete?id=3
        ...
        // [OK] http://localhost:4567/postdelete?id=1
        ...
        get("/postamigos", (request, response) -> PostService.postamigos(request, response));
